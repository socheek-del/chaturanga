...
More games may follow.

## What you get

- 📚 **Lessons from zero.** Short lessons covering the board, every piece and the endings. Every answer is
  checked by the game's own rules, not by a list of accepted answers.
- 🤖 **Six computer opponents** per game, each stronger than the last, with hints and take-backs while you
  learn.
...
- 🗣️ **Check the wording** in your language — the Thai, Burmese and Chinese reviews are all still open.
- ♟️ **Check the rules and lessons** if you know one of these games well.
- 🐛 [**Report a bug or suggest an idea**](https://github.com/socheek-del/chaturanga/issues/new).
- 💻 **Write code:** start with [CONTRIBUTING.md](CONTRIBUTING.md) and the
  [developer guide](docs/DEVELOPERS.md).

## For developers

How the code is laid out, how to run it, how it is tested and deployed:
[**docs/DEVELOPERS.md**](docs/DEVELOPERS.md). Why the repository is shaped this way, and what comes next:
...
<!-- The live site addresses are defined once here. -->
