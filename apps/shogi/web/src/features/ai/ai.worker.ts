...
import { Game } from '@chaturanga/shogi';
import { bestMove, chooseMove, positionKey } from '@chaturanga/shogi-ai';

/** The whole game, not just the position: Shogi repetitions are judged by what both sides did (sg-003). */
