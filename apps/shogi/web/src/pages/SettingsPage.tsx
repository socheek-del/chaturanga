...
function BoardSwatch({ theme }: { theme: BoardTheme }) {
  return (
    <div
      ...
      style={{ background: theme.board, borderColor: theme.line }}
    >
      <div className="absolute inset-0">
        <StarPoints theme={theme} />
      </div>
      <PieceSvg piece={{ color: 'w', type: 'r', promoted: false }} theme={theme} className="absolute left-[30%] top-[36%] h-[28%] w-[28%]" />
    </div>
  );
}
