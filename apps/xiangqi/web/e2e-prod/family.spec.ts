...
/**
 * xq-009: after a deploy, every live family site links to every sibling at its configured address, in the
...
for (const game of GAMES) {
  ...
  test(`${game.id} links to its siblings in production (xq-009)`, async ({ page }) => {
